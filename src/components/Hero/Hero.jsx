...
const Hero = ({ language }) => {
  const title = language === "de" ? "GEMEINNÜTZIGER VEREIN „ZIELE DER ZUKUNFT E.V.“" :
                language === "en" ? "NON-PROFIT ORGANIZATION „GOALS OF THE FUTURE“" :
                "ГРОМАДСЬКА ОРГАНІЗАЦІЯ „ЦІЛІ МАЙБУТНЬОГО“";
  const content = language === "de" ? "wurde im Jahr 2022 von Bürgern aus der Ukraine und Deutschland gegründet, nachdem Russland eine umfangreiche militärische Intervention in der Ukraine unternommen hatte. Unser Team hat sich zum Ziel gesetzt, humanitäre Unterstützung in der Ukraine bereitzustellen und die Integration ukrainischer Bürgerinnen und Bürger in Erfurt und Deutschland zu fördern." :
                language === "en" ? "was founded in 2022 by citizens from Ukraine and Germany after Russia undertook extensive military intervention in Ukraine. Our team aims to provide humanitarian aid in Ukraine and promote the integration of Ukrainian citizens in Erfurt and Germany." :
